...
const errorHandler = (err, req, res, next) =>{
    ...
    //  this tells the client what kind of error occurred (400 = ad request, 404 = not found, 500 = server error)
    ...
    res.json(
        {
            // The human-readable error message from the thrown Error object (e.g., "Price not found")
            message: err.message,
