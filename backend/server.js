...
// ── API Routes --------------------------
// Mount the prices and user routers under their respective base paths.
// All routes defined in pricingRoutes.js are prefixed with /api/data
// All routes defined in userRoutes.js are prefixed with /api/users
app.use('/api/prices', require('./routes/pricingRoutes'))
